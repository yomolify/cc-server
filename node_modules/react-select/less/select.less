...
<<<<<<< HEAD
@select-input-border-color:        rgba(red(30), green(126), blue(158), 0.5);
@select-input-border-radius:       4px;
@select-input-placeholder:         #aaa;
@select-input-border-focus:        rgba(red(30), green(126), blue(158), 0.2); // blue
...
=======
@select-input-border-color:        #e0f3da;
@select-input-border-radius:       1px;
@select-input-placeholder:         #aaa;
@select-input-border-focus:        rgba(red(30), green(126), blue(158), 0.2); // blue
